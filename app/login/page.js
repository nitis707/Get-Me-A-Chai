        ...
        <div className="text-white py-14 container mx-auto">
            ...
            <div className="social-login-buttons flex justify-center mt-10">
                <div className="flex flex-col gap-2 p-10 rounded">
                    <button
                        className="flex items-center border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium bg-gray-200 hover:bg-transparent hover:text-white text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    ...
                    <button
                        className="flex items-center border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium hover:bg-transparent hover:text-white text-black bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
